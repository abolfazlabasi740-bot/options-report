...
def build_tsetmc_snapshot(*, adapter: TSETMCAdapter | None=None, flow: int | None=None, max_instruments: int | None=None, symbol_prefix: str | None=None) -> dict[str,Any]:
    ...
    for instrument in instruments:
        ...
        rows.append({
            ...
            "market_watch_fields":market_fields,
            ...
            "quote":quote,"order_book":orderbook,"instrument_info":info,"orderbook_raw_levels":[],
            "quote_status":quote_status,"orderbook_status":"NOT_REQUESTED","instrument_info_status":info_status,"orderbook_level_count":0,
        })
        ...
        orderbook_evidence.append({"instrument_id":option_id,"status":"NOT_REQUESTED","source":"TSETMC","endpoint":"BestLimits/{instrument_id}","level_count":0,"market_watch_snapshot_sha256":mw.get("snapshot_sha256"),"identity_source_field":instrument.get("identity_source_field"),"source_market_timestamp":None,"quote_retrieved_at":quote_retrieved_at,"delta_seconds":None,"delta_status":"NOT_APPLICABLE_MARKET_WATCH_CANONICAL"})
